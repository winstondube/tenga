  ...
  return `<div class="card"><div class="card-b">
    <table class="t">
      ...
      <tbody>
        ...
        <tr><td>Shipping to Zimbabwe</td><td class="mono">${api.money(s.seaBoxes[0].price)} to ${api.money(s.seaBoxes[s.seaBoxes.length-1].price)} by sea, ${api.money(s.airRate)}/kg by air</td><td>Sea is a whole labelled box, air is by weight with a ${api.money(s.airMin)} minimum, plus ${api.money(s.clearance)} clearance. Collected in Harare, so no local delivery leg.</td></tr>
